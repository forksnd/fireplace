...
/**
 * A renderer for an {@link InlayChart} that draws data with a particular representation
 * (for example, lines or bars).
 */
public abstract class InlayRenderer {

    private final RectangleContent background;

    public InlayRenderer() {
        this(null);
    }
     ...
     */
    public InlayRenderer(RectangleContent background) {
