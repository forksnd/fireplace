 ...
 */
public class InlayChart implements RectangleContent {
    ...
    private final InlayRenderer renderer;
     ...
     */
    public InlayChart(InlayRenderer renderer) {
        this(null, renderer);
    }
     ...
     * @param renderer  the renderer ({@code null} not permitted).
     */
    public InlayChart(XYDataset dataset, InlayRenderer renderer) {
